...
// link.exe ContainmentOuterComponentWithRegFile.obj /DLL /DEF:ContainmentOuterComponentWithRegFile.def user32.lib gdi32.lib kernel32.lib ole32.lib oleaut32.lib /SUBSYSTEM:WINDOWS
...
// Co Class 
class CSumSubtract : public ISum, ISubtract, IMultiplication, IDivision     // inheritence list Left to Right : Adjustor Thunk
{
    private:
        long m_cRef;
